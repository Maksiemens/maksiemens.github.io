...
function clean_scripts() {
	...
	wp_enqueue_style( 'clean-google-font-primary', 'http://fonts.googleapis.com/css?family=Roboto:400,300,100,500' );
	wp_enqueue_style( 'clean-google-font-secondary', 'http://fonts.googleapis.com/css?family=Roboto+Slab:400,300,100,500' );
	...
	wp_enqueue_style( 'clean-style-secondary', get_template_directory_uri() . '/assets/css/style.css' );
